...
public class SamiService extends Service {
    ...
    private void setupSpeechRecognizer() {
        ...
        speechRecognizer.setRecognitionListener(
            ...
            public void onError(int error) {
                ...
                Log.d("SAMI", "Speech error: " + error);

                if (!destroyed) {
                    handler.postDelayed(
                            SamiService.this::startListening,
                            700
                    );
                }
            }
            ...
            public void onResults(Bundle results) {
                ...
                String original = matches.get(0).trim();

                String text =
                        original.toLowerCase(Locale.ROOT);

                Log.d("SAMI", "Recognized: " + original);
                ...
                if (waitingForCommand) {
                    ...
                    if (answer != null && !answer.trim().isEmpty()) {
                        ...
                        speak(
                                "معذرت، یہ command ابھی دستیاب نہیں ہے۔"
                        );
                    }
    ...
    private boolean isWakeWord(String text) {
        ...
        return text.contains("sami")
                ...
                || text.contains("semi")
                || text.contains("سامی")
                || text.contains("سامی اے آئی")
                || text.contains("sami ai");
    }
    ...
    private void startListening() {
        ...
        try {
            ...
            Log.e("SAMI", "Start listening error", e);
